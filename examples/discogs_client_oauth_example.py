...
# Your consumer key and consumer secret are provided by Discogs.
# See http://www.discogs.com/settings/developers to generate your own. A key
# and secret is required for this example.
...
user_agent = 'discogs_client_oauth_example/1.0'
